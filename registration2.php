            ...
            <div class="info">
                <form action="registration.php?reg=<?php echo $e_id; ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Event Name (Firstname Lastname)" name="u_name" required>
                    </div>
                    <br>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="email" placeholder="Enter class of studying" name="u_std" required>
                    </div>
                    <br>
                    <div class="form-group">
                        <label for="event_weekday">School Name:</label>
                        <input type="text" class="form-control" placeholder="Enter your school name" name="u_school" required>
                    </div>
                    <br>
                    <div class="form-group">
                        <label for="event_month">City:</label>
                        <input type="text" class="form-control" placeholder="Enter city" name="u_city" required>
                    </div>
                    <br>
                    <div class="form-group">
